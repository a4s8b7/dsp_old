...
value of 1090 <-- highest value

increment_value = highest_value / 10

/* ooooooooooooooooooooooooooooooooo Page One Bar Graph ooooooooooooooooooooooooooooooo */

pg(1) / increment_value = step_value
round step_value to the nerest one's place
 {
        blank_space = (step_value +1) - 10

	int i=0; 
	while(i<blank_space) {
	  sprintf(intro, "<tr><td><IMG SRC="w-brick.jpg" HEIGHT=15 WIDTH=50></td></tr>")
	  fwrite(intro, 60, 1, handle);
	  i++;   
	}
	
	fwrite ("<tr><td><IMG SRC="r2-brick.jpg" HEIGHT=15 WIDTH=50></td></tr>")
	
for (int i=0; i<step_value; i++)   {

	fwrite ("<tr><td><IMG SRC="r1-brick.jpg" HEIGHT=15 WIDTH=50></td></tr>")	
     }
	{
		fwrite("/table>")
		...
		fwrite("<table border="0" celspacing="0" cellpadding="0">")
	}

/* ooooooooooooooooooooooooooooooooo Page Two Bar Graph ooooooooooooooooooooooooooooooo */

pg(2) / increment_value = step_value
round step_value to the nerest one's place
 {
   int blank_space = (step_value +1) - 10
 }
for (int i=0; i<blank_space; i++)  {

	fwrite ("<tr><td><IMG SRC="w-brick.jpg" HEIGHT=15 WIDTH=50></td></tr>")
     }
...
/* ooooooooooooooooooooooooooooooooo Page Three Bar Graph ooooooooooooooooooooooooooooooo */

pg(3) / increment_value = step_value
round step_value to the nerest one's place
 {
   int blank_space = (step_value +1) - 10
 }
...
/* ooooooooooooooooooooooooooooooooo Page Four Bar Graph ooooooooooooooooooooooooooooooo */

pg(4) / increment_value = step_value
round step_value to the nerest one's place
 {
   int blank_space = (step_value +1) - 10
 }
...
/* ooooooooooooooooooooooooooooooooo Page Five Bar Graph ooooooooooooooooooooooooooooooo */

pg(5) / increment_value = step_value
round step_value to the nerest one's place
 {
   int blank_space = (step_value +1) - 10
 }
...
/* ooooooooooooooooooooooooooooooooo Page Six Bar Graph ooooooooooooooooooooooooooooooo */

pg(6) / increment_value = step_value
round step_value to the nerest one's place
 {
   int blank_space = (step_value +1) - 10
 }
...
/* ooooooooooooooooooooooooooooooooo Page Seven Bar Graph ooooooooooooooooooooooooooooooo */

pg(7) / increment_value = step_value
round step_value to the nerest one's place
 {
   int blank_space = (step_value +1) - 10
 }
...
/* ooooooooooooooooooooooooooooooooo Page Eight Bar Graph ooooooooooooooooooooooooooooooo */

pg(8) / increment_value = step_value
round step_value to the nerest one's place
 {
   int blank_space = (step_value +1) - 10
 }
...
/* ooooooooooooooooooooooooooooooooo Page Nine Bar Graph ooooooooooooooooooooooooooooooo */

pg(9) / increment_value = step_value
round step_value to the nerest one's place
 {
   int blank_space = (step_value +1) - 10
 }
...
/* ooooooooooooooooooooooooooooooooo Page Ten Bar Graph ooooooooooooooooooooooooooooooo */

pg(10) / increment_value = step_value
round step_value to the nerest one's place
 {
   int blank_space = (step_value +1) - 10
 }
...
/* ooooooooooooooooooooooooooooooooo Page Eleven Bar Graph ooooooooooooooooooooooooooooooo */

pg(11) / increment_value = step_value
round step_value to the nerest one's place
 {
   int blank_space = (step_value +1) - 10
 }
...
/* ooooooooooooooooooooooooooooooooo Page Twelve Bar Graph ooooooooooooooooooooooooooooooo */

pg(12) / increment_value = step_value
round step_value to the nerest one's place
 {
   int blank_space = (step_value +1) - 10
 }
...
for (int i=0; i<step_value; i++)   {
     ...
     }
	{
		...
		fwrite("<td><img src="w-brick.jpg" HEIGHT=10 WIDTH=50></td>")

		fwrite("<td>"; pg(1); "</td><td>"; pg(2); "</td><td>"; pg(3); "</td><td>"; pg(4); "</td>")
		fwrite("<td>"; pg(5); "</td><td>"; pg(6); "</td><td>"; pg(7); "</td><td>"; pg(8); "</td>")
		fwrite("<td>"; pg(9); "</td><td>"; pg(10); "</td><td>"; pg(11); "</td><td>"; pg(12); "</td></tr>")
		fwrite("</table>")
	}
